...
SMS_MMS_FALLBACK_TO_TEXT = _as_bool(os.getenv("SMS_MMS_FALLBACK_TO_TEXT", "true"))
QR_IMAGE_DIR = Path(os.getenv("QR_IMAGE_DIR", str(BASE_DIR / "data" / "qr")))
USE_S3_FOR_QR = _as_bool(os.getenv("USE_S3_FOR_QR", "false"))
AWS_ACCESS_KEY_ID = os.getenv("AWS_ACCESS_KEY_ID", "")
AWS_SECRET_ACCESS_KEY = os.getenv("AWS_SECRET_ACCESS_KEY", "")
AWS_S3_BUCKET_NAME = os.getenv("AWS_S3_BUCKET_NAME", "")
AWS_S3_REGION = os.getenv("AWS_S3_REGION", "us-east-1")
AWS_S3_QR_PREFIX = os.getenv("AWS_S3_QR_PREFIX", "qr")
